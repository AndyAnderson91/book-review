...
class IndexListViewTest(TestCase):
    ...
    def test_view_accessible_by_name(self):
        ...
        """
        response = self.client.get(reverse('book_review:index'))
...
class ReviewCreateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user = User.objects.create_user(username='andy', password='1')
        cls.write_review_url = reverse('book_review:add_review', kwargs={
            'pk': cls.book.id,
            'slug': cls.book.slug
        })
        cls.new_review_data = {
...
class ReviewUpdateViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.book = create_books(1, published=True)[0]
        cls.user = User.objects.create_user(username='andy', password='1')
        cls.update_review_url = reverse('book_review:edit_review', kwargs={
            'pk': cls.book.id,
            'slug': cls.book.slug
        })
...
class ReviewDeleteViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.book = create_books(1, published=True)[0]
        cls.user = User.objects.create_user(username='andy', password='1')
        cls.delete_review_url = reverse('book_review:delete_review', kwargs={
            'pk': cls.book.id,
            'slug': cls.book.slug
        })
...
class MyReviewListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user = User.objects.create_user(username='andy', password='1')
        cls.my_reviews_url = reverse('book_review:my_reviews')
...
class SearchListViewTest(TestCase):
    ...
    def test_view_accessible_by_name(self):
        response = self.client.get(reverse('book_review:search'))
        self.assertEqual(response.status_code, 200)
